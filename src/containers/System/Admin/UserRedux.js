...
class UserRedux extends Component {
    ...
    render() {
        ...
        let {email, password, firstName, lastName, address, gender , role, phoneNumber, position, avatar } = this.state
                        ...
                        <form className="row g-3">
                            ...
                            <div className="col-md-3">
                                ...
                                <div className="preview-img-container">
                                    ...
                                    />
                                    <label className="label-upload" htmlFor='previewImg'>Tải ảnh <i className="fas fa-cloud-upload-alt"></i></label>
